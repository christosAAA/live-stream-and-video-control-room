...
import { VideosListDataContext,VideosInfoFromFileProps } from "../contexts/VideoListCreateContext";

type fullVideoArrayProps = { [x: string]: string }

export const useVideoList = () => {
  const videoFullList:VideosInfoFromFileProps = useContext(VideosListDataContext);
